...
export class Clipboard {
  ...
  protected readonly inputSnippet = `import { Component } from '@angular/core';

import { CopyButtonComponent } from './shared/ui-lib';

@Component({
  selector: 'app-copy-input-example', imports: [CopyButtonComponent], template: \`
...
@Component({
  selector: 'app-copy-projected-example', imports: [CopyButtonComponent], template: \`
...
export class CopyProjectedExample {}`;
  ...
  protected readonly revealSnippet = `import { Component } from '@angular/core';

import { CopyRevealComponent } from './shared/ui-lib';

@Component({
  selector: 'app-copy-reveal-example', imports: [CopyRevealComponent], template: \`
...
export class CopyRevealExample {}`;
  ...
  protected readonly helperSnippet = `import { Component, signal } from '@angular/core';
